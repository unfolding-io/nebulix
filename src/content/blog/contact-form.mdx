...
Nebulix contact form supports multiple topics, every topic can have their own desination email or slack channel. to open the contact dialog just create a link `href="#contact"`
